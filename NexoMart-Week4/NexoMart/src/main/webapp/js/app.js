...
const NexoMart = (() => {
    ...
    // ---------- Seller: incoming orders (Week 4 — completes the dashboard) ----------
    ...
    async function loadIncomingOrders() {
        ...
        try {
            ...
            body.innerHTML = `<tr><td colspan="4">Could not load orders: ${escapeHtml(err.message)}</td></tr>`;
        }
    }
    ...
    return { initBrowsePage, initCartPage, initSellerDashboard, initAdminDashboard };
})();
